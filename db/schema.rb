...
ActiveRecord::Schema.define(version: 20150903184341) do
  ...
  add_index "execs", ["email"], name: "index_execs_on_email", using: :btree
  add_index "execs", ["reset_password_token"], name: "index_execs_on_reset_password_token", unique: true, using: :btree
  add_index "execs", ["uid", "provider"], name: "index_execs_on_uid_and_provider", unique: true, using: :btree
